...
/**
 * 库房环境限值规则 Service接口（rule-eval 形状：规则求值，无增删改）
 *
 * @author fuce
 * @date 2026-09-14
 */
public interface ITArvEnvRuleService {

    /** 按主键查询规则 */
    TArvEnvRule selectTArvEnvRuleById(Long id);
    ...
    List<TArvEnvRule> listAvailable(Date at);
